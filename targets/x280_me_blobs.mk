...
$(build)/coreboot-$(CONFIG_COREBOOT_VERSION)/$(BOARD)/.build: \
    $(pwd)/blobs/xx80/x280_me.bin $(pwd)/blobs/xx80/x280_tb.bin $(build)/$(BOARD)/x280_tb.bin	

$(pwd)/blobs/xx80/x280_me.bin $(pwd)/blobs/xx80/x280_tb.bin &:
	$(pwd)/blobs/xx80/x280_download_clean_deguard_me_pad_tb.sh \
		-m $(pwd)/blobs/utils/me_cleaner/me_cleaner.py $(pwd)/blobs/xx80

$(build)/$(BOARD)/x280_tb.bin: $(pwd)/blobs/xx80/x280_tb.bin
	cp $(pwd)/blobs/xx80/x280_tb.bin $(build)/$(BOARD)
