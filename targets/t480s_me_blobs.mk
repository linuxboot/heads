...
$(build)/coreboot-$(CONFIG_COREBOOT_VERSION)/$(BOARD)/.build: \
    $(pwd)/blobs/xx80/t480s_me.bin $(pwd)/blobs/xx80/t480s_tb.bin $(build)/$(BOARD)/t480s_tb.bin	

$(pwd)/blobs/xx80/t480s_me.bin $(pwd)/blobs/xx80/t480s_tb.bin &:
	$(pwd)/blobs/xx80/t480s_download_clean_deguard_me_pad_tb.sh \
		-m $(pwd)/blobs/utils/me_cleaner/me_cleaner.py $(pwd)/blobs/xx80

$(build)/$(BOARD)/t480s_tb.bin: $(pwd)/blobs/xx80/t480s_tb.bin
	cp $(pwd)/blobs/xx80/t480s_tb.bin $(build)/$(BOARD)
